...
public class MoveController : MonoBehaviour {
    ...
    void Update () {
        if (Input.touchCount > 0) {
            ...
            if (_activeObject != null) {
                /* Only proceed moving if the tracking plane is available */
                if (_controller.InstantTarget != null) {
                    ...
                    Plane p = new Plane(_controller.InstantTarget.transform.up, _controller.InstantTarget.transform.position);
                    ...
                    if (p.Raycast(cameraRay, out enter)) {
                        ...
                        position.y = Mathf.Clamp(position.y, -15.0f, 15.0f);
